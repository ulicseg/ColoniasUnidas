...
export const IncomeChart: React.FC = () => {
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-neutral-900 text-white p-3 rounded-xl shadow-xl border border-neutral-800 text-xs z-50">
          ...
          <p className="text-neutral-400 mt-0.5 font-medium text-[11px]">{data.porcentaje}% del total de ingresos</p>
        </div>
      );
    }
    return null;
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full pt-3 border-t border-neutral-100 flex flex-wrap justify-center gap-x-4 gap-y-2 text-xs">
